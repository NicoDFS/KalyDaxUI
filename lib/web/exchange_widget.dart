...
import 'package:kalydax/components/order_placement_screen_with_button.dart';
import 'package:kalydax_redux/redux.dart';
  ...
  void didUpdateWidget(oldWidget) {
    ...
    if (widget.selectedMarket.id != oldWidget.selectedMarket.id &&
      ...
      webviewController.loadContent(
        'http://localhost:4000/tradingview/?id=${widget.selectedMarket.id}&name=${widget.selectedMarket.baseUnit.id.toUpperCase()}-${widget.selectedMarket.quoteUnit.id.toUpperCase()}&lang=en&quote_unit=${widget.selectedMarket.quoteUnit.id}',
        SourceType.URL,
      );
    }
  }
